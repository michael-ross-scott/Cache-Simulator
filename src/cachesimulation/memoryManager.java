...
public class memoryManager 
{
    ...
    */
    ...
    {
        double primaryMiss = 1 - getPercentageOfL1Hits() / 100;
        double secondaryMiss = 1 - getPercentageOfL2Hits() / 100;
        double effCPI = 1 + primaryMiss*100 + secondaryMiss*1000;
        return effCPI;
    }
    ...
    */
    ...
    {
        double primaryMiss = 1 - getPercentageOfL1Hits() / 100;
        double effCPI = 1 + primaryMiss*1000;
        return effCPI;
    }
