...
public class fileHandling {
    ...
    */
    ...
    public void printCacheOutput1(simulator s) throws FileNotFoundException, IOException
    {
        ...
        String heading4 = String.format("%-25s", "Number of hits on index");
    ...
    public void printCacheOutput2(simulator s) throws FileNotFoundException, IOException
    {
        File output = new File("results.txt");
